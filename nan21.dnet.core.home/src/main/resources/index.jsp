...
<body>
	...
	<table align=center style='vertical-align: middle; align: center'>
		<tr>
			<td
				style='font-family: arial, verdana; font-size: 16px; text-align: center; font-weight: bold;'>
				Open source ERP</td>
		</tr>
		<tr>
		...
		<tr>
			<td align=center style='padding-top: 10px;'><a
				href="/nan21.dnet.core.web"><IMG style="border: 0px solid #ccc;"
					src="resources/images/dnet_logo_extrabig_red.png"></a></td>
		</tr>
		...
		<tr>
			<td
				...
				colspan=2><br> Copyright &copy; 2010-<%=Calendar.getInstance().get(Calendar.YEAR)%>
