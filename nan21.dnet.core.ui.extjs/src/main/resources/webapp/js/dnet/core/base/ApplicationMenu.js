...
Ext
		.define(
				"dnet.core.base.ApplicationMenu",
				{
					...
					/**
					 * Set the default company name in the corresponding
					 * element.
					 */
					setCompanyText : function(v) {
						try {
							...
							this.items
									.get(
											"net.nan21.dnet.core.menu.ApplicationMenu$Item$CompanyName")
									.setText(_v);
						} catch (e) {
						}
					},
					...
					_createAppInfo_ : function() {
						return {
							...
							text : "<span>"
									+ Dnet.productInfo.name
									+ " </span><br><span>"
									+ Dnet.translate("appmenuitem",
											"version__lbl") + ": "
									+ Dnet.productInfo.version
									+ "</span></span>"
						};
					},
					...
					_createRight_ : function() {
						return [
								...
								{
									xtype : "tbtext",
									id : "net.nan21.dnet.core.menu.ApplicationMenu$Item$CompanyLabel",
									text : Dnet.translate("appmenuitem",
											"company__lbl")
								},
								{
									xtype : "tbtext",
									id : "net.nan21.dnet.core.menu.ApplicationMenu$Item$CompanyName",
									text : "-",
									style : "font-weight:bold;"
								}, {
									xtype : "tbspacer",
						...
						if (!Ext.isEmpty(list) && Ext.isArray(list)) {
							...
							for ( var i = 0; i < list.length; i++) {
								...
								var _item = {
									...
									_frame : e.frame,
									handler : function() {
										getApplication().showFrameByName(
												this._bundle, this._frame);
									}
								}
